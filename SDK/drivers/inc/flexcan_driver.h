...
#if FEATURE_CAN_YFTECH_PATCH
    FLEXCAN_EVENT_BUS_OFF,
#endif
    FLEXCAN_EVENT_ERROR
...
#if FEATURE_CAN_YFTECH_PATCH
    flexcan_msgbuff_id_type_t id_type;  /*!< Type of message ID (standard or extended)*/
#endif
...
#if FEATURE_CAN_YFTECH_PATCH
status_t FLEXCAN_DRV_ChkHaveInit(uint32_t instance);
uint8_t FLEXCAN_DRV_IsBusOffStatus(uint32_t instance);
uint8_t FLEXCAN_DRV_IsACKErrStatus(uint32_t instance);
#endif
